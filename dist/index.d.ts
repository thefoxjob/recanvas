...
export * from './hooks';
export { type LayoutStyle, type RecanvasFont, type ThemeStyle, RecanvasFontFamily, RecanvasFontStyle, RecanvasFontVariant, RecanvasFontWeight, } from './types';
...
export declare function useCanvas(element: React.ReactElement, options: CanvasOptions): (props: React.HTMLAttributes<HTMLCanvasElement>) => import("react").DetailedReactHTMLElement<{
    ref: import("react").RefObject<HTMLCanvasElement>;
    height: number;
    width: number;
    tabIndex: number;
...
export declare function useCanvasOptions(): CanvasContext;
