...
export declare enum RecanvasFontFamily {
    Monospace = "monospace",
    Serif = "serif",
...
export declare enum RecanvasFontWeight {
    Normal = "normal",
    Bold = "bold",
    Bolder = "bolder",
    Lighter = "lighter"
}
export declare enum RecanvasFontStyle {
    Normal = "normal",
    Italic = "italic",
    Oblique = "oblique"
}
export declare enum RecanvasFontVariant {
    Normal = "normal",
